...
<head>
  ...
  <title>Mapato | Add Savings </title>
    ...
    <div class="row">
        ...
        <?php
          ...
          if(isset($_POST['add'])) {
            ...
            $uid=$row['id'];
            $sql1="SELECT SUM(amount) FROM savings WHERE `userId`='$uid' ";
            $qry1=mysqli_query($conn,$sql1);
            $res=mysqli_fetch_array($qry1);
            $total=$res['SUM(amount)']+$amount;

            $sql="INSERT INTO `savings`(`userId`,`date`,`amount`,`total`) VALUES ('$uid','$date','$amount','$total')";
            $qry=mysqli_query($conn,$sql);
        ...
        <div class="col-md-12 mx-auto mt-2">
            <div class="card card-navy" style="opacity:94%;">
                <div class="card-header">
                  <h3 class="card-title text-light"><i class="fa fa-plus"></i> Add Saving </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="quickForm" action="" method="post">
                  ...
                  <div class="card-footer">
                    <button type="submit" name="add" class="btn btn-outline-danger ">Add Saving</button>
                  </div>
                </form>
              </div>
              <!-- /.card -->
