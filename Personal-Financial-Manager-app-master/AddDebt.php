...
if(isset($_POST['add'])) {
  ...
  $sql="INSERT INTO `debt` (`userId`,`owner`,`reason`,`damount`, `repay_date`,`pamount`,`remain`) VALUES ('$uid','$owner','$reason','$damount', '$date','$pamount','$remain')";
  $qry=mysqli_query($conn,$sql);
            ...
            <div class="card card-navy" style="opacity:94%;">
                ...
                <form id="quickForm" action="" method="post">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Repay Date</label>
                        <input type="date" name="date" class="form-control" id="exampleInputEmail1" placeholder="Repay date">
                    </div>
